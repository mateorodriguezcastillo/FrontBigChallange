...
export const NoPrescriptionIcon: FC<IconProps> = ({ className }) => {
  return (
    <svg
      ...
      strokeWidth="1.5"
      stroke="currentColor"
      className={tw("h-6 w-6", className)}
    >
      <path
        strokeLinecap="round"
...
export const LightModeIcon: FC<IconProps> = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const EyeSlashIcon: FC<IconProps> = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
  ...
  return (
    <div>
      <svg
        aria-hidden="true"
        className={tw(
          "mr-2 h-6 w-6 animate-spin fill-blue-600 text-gray-200 dark:text-gray-600",
          className
        )}
        viewBox="0 0 100 101"
        fill="none"
